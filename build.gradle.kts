...
kotlin {
    ...
    val xcf = XCFramework("Getrandom")

    macosArm64 {
        binaries.framework { baseName = "Getrandom"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "Getrandom"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "Getrandom"
        flattenPackage = "io.github.kotlinmania.getrandom"
    }

    android {
        namespace = "io.github.kotlinmania.getrandom"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "getrandom-kotlin", version.toString())

    pom {
        name.set("getrandom-kotlin")
        description.set("Kotlin Multiplatform port of rust-random/getrandom - cross-platform OS-provided random byte source")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/getrandom-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/getrandom-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/getrandom-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/getrandom-kotlin.git")
        }
    }
}
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            val sentinelFile = sentinelDir.get().asFile.resolve(
                "io/github/kotlinmania/getrandom/codeql/_CodeqlEmptySource.kt",
            )
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.getrandom.codeql

...
//      `import Getrandom` above would fail at compile time.
//
//   2. The static archive `libGetrandom.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Getrandom" }` and
//      `flattenPackage = "io.github.kotlinmania.getrandom"` configuration in
...
//      via the `GetrandomLibrary` product.
//
...
final class GetrandomExportTests: XCTestCase {
